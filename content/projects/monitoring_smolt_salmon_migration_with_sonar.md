...
*Example ARIS sonar frame: an acoustic image showing fish targets in the sonar beam.*
...
*The detector reads a noisy sonar frame and returns a box and confidence score for each smolt, ignoring the background clutter.*
