...
description: An intuition-first, visual guide to metric learning and how machines learn to tell individual animals apart for conservation re-identification.
date: 2026-06-16
...
The obvious first instinct is to train a classifier, with one output per
...
*A classifier needs a slot per identity, so a new individual means a retrain. Metric learning just drops another point into the space.*
