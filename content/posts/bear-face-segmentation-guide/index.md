...
{{< gallery caption="Different individuals from the <a href=\"https://bearresearch.org\" target=\"_blank\">BearID Project</a>" >}}
...
Before modelling, we explored the dataset to understand what we were working
with — and, importantly, where the provided labels fell short.
...
<div class="gallery-box">
  ...
  <em>Provided labels by <a href="https://bearresearch.org">The BearID Project</a> — Amber (left) and Bella (right)</em>
</div>
...
>
> <cite>Labeling instructions</cite>
...
list of classes — so you can ask it for "head of bear" directly.
...
The image below summarizes the approach taken to generate the segmented bear
...
![Training Results](./images/evaluation/training.png#noround)
...
![Precision Recall Curve](./images/evaluation/precision_recall.png#noround)
...
The fine-tuned instance segmentation model cleanly cuts out bear faces, laying
a solid foundation for the rest of the bear identification system — and the same
approach transfers to other species.

![Generated Chips](./images/chips.png)
*Segmented bear faces produced by the model*

<div class="about-cta">
  <h3 class="about-cta__title">See the full picture</h3>
  <p class="about-cta__description">Face segmentation is just the first stage. Explore the complete bear identification project — from a camera-trap photo all the way to a recognised individual.</p>
