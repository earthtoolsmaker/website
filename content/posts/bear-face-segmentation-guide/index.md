...
We initiated GroundingDINO with the textual prompt: "head of bear", and evaluated its ability to localize bear heads by comparing its outputs with the manually annotated dataset. Intersection over Union (IoU) 
